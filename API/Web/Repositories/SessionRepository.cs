...
namespace JanaticsAdminPortal.API.Repositories
{
    ...
    public class SessionRepository
    {
            ...
            int userId, string sessionToken, DateTime expiresAtUtc, string? ipAddress, string? machineName)
        {
            ...
            await conn.Connection.ExecuteAsync("JAN_PKG_JAN_USER_SESSION.P_TRY_CREATE_SESSION", p, commandType: CommandType.StoredProcedure);
        ...
        public async Task EndSessionAsync(string sessionToken)
        {
            ...
            var p = new OracleDynamicParameters();
            p.Add("P_SESSION_TOKEN", sessionToken, OracleMappingType.Varchar2, ParameterDirection.Input);
            await conn.Connection.ExecuteAsync("JAN_PKG_JAN_USER_SESSION.P_END_SESSION", p, commandType: CommandType.StoredProcedure);
        }
        ...
        public async Task<bool> ValidateAndTouchAsync(string sessionToken)
        {
            ...
            await conn.Connection.ExecuteAsync("JAN_PKG_JAN_USER_SESSION.P_VALIDATE_AND_TOUCH_SESSION", p, commandType: CommandType.StoredProcedure);
        ...
        public async Task<IEnumerable<dynamic>> ListActiveAsync()
        {
            ...
            return await conn.Connection.QueryAsync("JAN_PKG_JAN_USER_SESSION.P_LIST_ACTIVE_SESSIONS", p, commandType: CommandType.StoredProcedure);
        }
        ...
        public async Task<bool> ForceEndAsync(int sessionId)
        {
            ...
            p.Add("P_RESULT_CODE", dbType: OracleMappingType.Int32, direction: ParameterDirection.Output);
            p.Add("P_RESULT_MSG", dbType: OracleMappingType.Varchar2, direction: ParameterDirection.Output, size: 400);
            await conn.Connection.ExecuteAsync("JAN_PKG_JAN_USER_SESSION.P_FORCE_END_SESSION", p, commandType: CommandType.StoredProcedure);
        ...
        public async Task EndAllForUserAsync(int userId)
        {
            ...
            var p = new OracleDynamicParameters();
            p.Add("P_USER_ID", userId, OracleMappingType.Int32, ParameterDirection.Input);
            await conn.Connection.ExecuteAsync("JAN_PKG_JAN_USER_SESSION.P_END_ALL_SESSIONS_FOR_USER", p, commandType: CommandType.StoredProcedure);
        }
    }
}
