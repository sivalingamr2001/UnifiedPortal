...
public class ProcedureResult
{
    ...
    /// <summary>Populated when the caller left the entity's Code field blank and the
    /// database auto-generated one (e.g. "ROL008") - null if the caller supplied their own.</summary>
